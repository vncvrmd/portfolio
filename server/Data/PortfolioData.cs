...
public static class PortfolioData
{
    ...
    public static readonly IReadOnlyList<Project> Projects = new[]
    {
        ...
        new Project(6, "Falcon Eye", "Campus safety and lost & found web application for a school community, with account registration and sign-in.", "https://falcon-eye.vercel.app", TechStack: new[] { "React" })
    };
}
